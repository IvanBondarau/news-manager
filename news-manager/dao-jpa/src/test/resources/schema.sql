...
CREATE SEQUENCE news_manager.author_sequence
    INCREMENT 1
    START 1
    MINVALUE 1;

CREATE SEQUENCE news_manager.news_sequence
    INCREMENT 1
    START 1
    MINVALUE 1;

CREATE SEQUENCE news_manager.tag_sequence
    INCREMENT 1
    START 1
    MINVALUE 1;


ALTER DATABASE news_manager_test SET search_path TO news_manager;
