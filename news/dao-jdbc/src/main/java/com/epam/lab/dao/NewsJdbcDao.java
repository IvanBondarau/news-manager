...
@Repository
public class NewsJdbcDao extends AbstractDao implements NewsDao {

    private static final Logger logger = Logger.getLogger(NewsJdbcDao.class);
    ...
    private static final String SELECT_ALL_STATEMENT =
            "SELECT id, title, short_text, full_text, creation_date, modification_date FROM public.news";
    ...
    private static final String COUNT_ALL_STATEMENT = "SELECT COUNT(*) FROM news";
    ...
    public List<News> getAll() {
        return jdbcTemplate.query(SELECT_ALL_STATEMENT, new NewsRowMapper());
    }

    @Override
    public Long count() {
        return jdbcTemplate.queryForObject(COUNT_ALL_STATEMENT, (resultSet, i) -> resultSet.getLong(1));
    }
